...
async def ping(e):
    if e.sender_id in SUDO_USERS:
        start = datetime.now()
        altron = await e.reply(f"» 𝐓𝐖𝐈𝐍𝐊𝐄𝐋 𝐓𝐖𝐈𝐍𝐊𝐄𝐋 𝐋𝐈𝐓𝐓𝐋𝐄 𝐒𝐓𝐀𝐑👀🦋🌟𝐈 𝐃𝐎𝐍'𝐓 𝐂𝐀𝐑𝐄🤧𝐖𝐇𝐀𝐓 𝐓𝐇𝐄 𝐅𝐔𝐂𝐊 𝐘𝐎𝐔 𝐀𝐑𝐄 😈")
        end = datetime.now()
        mp = (end - start).microseconds / 1000
        await altron.edit(f"𝐓𝐖𝐈𝐍𝐊𝐄𝐋 𝐓𝐖𝐈𝐍𝐊𝐄𝐋 𝐋𝐈𝐓𝐓𝐋𝐄 𝐒𝐓𝐀𝐑👀🦋🌟𝐈 𝐃𝐎𝐍'𝐓 𝐂𝐀𝐑𝐄🤧𝐖𝐇𝐀𝐓 𝐓𝐇𝐄 𝐅𝐔𝐂𝐊 𝐘𝐎𝐔 𝐀𝐑𝐄 😈\n» `{mp} ᴍꜱ`")
